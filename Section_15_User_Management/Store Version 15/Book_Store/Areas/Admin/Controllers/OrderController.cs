...
namespace Book_Store.Areas.Admin.Controllers
{
	...
	public class OrderController : Controller
	{
        ...
        public IActionResult ShipOrder()
        {
            ...
            var htmlMessage = $"<p>Your order: {orderHeader.Id} has been shipped, shipment details is as follows <br/>" +
                $"Tracking number: {orderHeader.TrackingNumber} <br/>" +
                $"Carrier: {orderHeader.Carrier}</p>";
