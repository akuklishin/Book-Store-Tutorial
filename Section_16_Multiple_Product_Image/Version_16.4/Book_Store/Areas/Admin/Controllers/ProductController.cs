...
namespace Book_Store.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult DeleteImage(int imageId){
            //get image from ProductImages table in database
            var imageToBeDeleted = _unitOfWork.ProductImage.Get(u => u.Id == imageId);
            //get product id of that image
            int productId = imageToBeDeleted.ProductId;
            if(imageToBeDeleted != null){
                //if image to be deleted and it's imageUrl both not null 
                if (!string.IsNullOrEmpty(imageToBeDeleted.ImageUrl)){                   

                    //get imagePath
                    var imagePath =Path.Combine(_webHostEnvironment.WebRootPath,
                        imageToBeDeleted.ImageUrl.TrimStart('\\'));
                    //delete the image if exist from wwwroot/images/products/productId
        ...
        public IActionResult Delete(int? id){
            ...
            if (Directory.Exists(finalPath)){
                ...
                //loop through the list of all file and delete them all
