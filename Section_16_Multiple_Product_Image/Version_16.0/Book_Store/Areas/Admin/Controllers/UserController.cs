...
namespace Book_Store.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller {
        /*Although not recommended, instead of IUnitOfWork we are directly using
          ApplicationDbContext for learning purpose*/
        ...
        public IActionResult GetAll(){
            ...
            //get all userRoles so that we don't need to fetch it again again while iterating through all users
            var userRoles = _db.UserRoles.ToList();
            var roles = _db.Roles.ToList();

            foreach (var user in objUserList){
                //assign role to user from userId using userRoles and roles lists
