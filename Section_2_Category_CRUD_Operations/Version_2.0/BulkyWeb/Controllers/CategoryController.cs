...
using BulkyWeb.Data; // This provides access to the ApplicationDbContext, which interacts with the database
using BulkyWeb.Models; // This provides access to the Category model
...
namespace BulkyWeb.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public IActionResult Create(Category obj) // adding the (Category obj) so the values of the new category will be added to the db
        {
            ...
            // check if obj.Name is equal to "test" - demonstrate purpose of "ModelOnly" ASP Validation Summary Option
            //if (obj.Name.ToLower() == "test")
            //{
            //    ModelState.AddModelError("", "Test is an invalid value."); // custom error message
            //}
